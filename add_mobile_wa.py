...
for file in html_files:
    ...
    if 'class="mobile-wa-btn"' not in content:
        # inject right before </body>
        idx = content.find('</body>')
        if idx != -1:
            content = content[:idx] + wa_html + '\n' + content[idx:]
            with open(file, 'w', encoding='utf-8') as f:
                f.write(content)
            print(f'Added mobile WA button to {file}')
